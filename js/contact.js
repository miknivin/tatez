    document.getElementById('contactForm').addEventListener('submit', function(event) {
      ...
      if (!firstName || !lastName || !email || !phone) {
        errorMessageDiv.textContent = 'Please fill out all fields except message.';
        return;
      }
      ...
      .then(response => {
        if (!response.ok) {
          errorMessageDiv.textContent = 'Error sending message: Network response was not ok';
      ...
      .then(data => {
        ...
        // Clear form fields
        document.getElementById('cust-contact-first-name').value = '';
        document.getElementById('cust-contact-last-name').value = '';
        document.getElementById('cust-contact-email').value = '';
        document.getElementById('cust-contact-phone').value = '';
        document.getElementById('cust-contact-message').value = '';
      })
      .catch(error => {
