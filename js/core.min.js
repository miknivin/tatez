...
function multitoggles() {
  ...
  Toggle.prototype.init = function () {
    ...
    this.selectorGroup =
      "[" + options.attrToggle + '="' + this.selectorTarget + '"]';
    ...
    this.nodesIsolate = document.querySelectorAll(
      "[" + options.attrIsolate + "]",
    );
  };
  ...
  Toggle.prototype.checkToggleTarget = function (target) {
    if (
      target.hasAttribute(options.attrToggle) &&
      this.selectorTarget !== target.getAttribute(options.attrToggle)
    )
      return false;
    return true;
  };
  ...
  for (var i = 0; i < toggles.length; i++) {
    toggles[i].node.addEventListener(
      "click",
      (function (toggle) {
        return function () {
