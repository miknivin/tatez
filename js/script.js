    ...
    function initMaps() {
      ...
      $.getScript(
        ...
        function () {
          ...
          for (var i = 0; i < plugins.maps.length; i++) {
            var zoom =
              parseInt(plugins.maps[i].getAttribute("data-zoom")) || 11;
            var styles;
...
const items = [
  { id: 1, title: 'Aviyal' },
  { id: 2, title: 'Chakka Puzhukku' },
  { id: 3, title: 'Angamaly Mango Curry' },
  { id: 4, title: 'Bitter guard Thoran' },
  { id: 5, title: 'Cheera Thoran' },
  { id: 6, title: 'Ada Pradhaman' },
  { id: 7, title: 'Chakkakuru Mango Curry' },
  { id: 8, title: 'Banana Roast' },
  { id: 9, title: 'Banana Fry' },
  { id: 10, title: 'Chilli Porottta' },
  { id: 11, title: 'Chapathi' },
  { id: 12, title: 'Ela Ada Jackfruit' },
  { id: 13, title: 'Ela Ada Jaggery' },
  { id: 14, title: 'Idiyappam' },
  { id: 15, title: 'Fried Rice' },
  { id: 16, title: 'Jalebi' },
  { id: 17, title: 'Kodappan Cherupayar Thoran' },
  { id: 18, title: 'Laddu Family Pack' },
  { id: 19, title: 'Idichakka Thoran' },
  { id: 20, title: 'Dosa Sambar' },
  { id: 21, title: 'Gobi Manchurian' },
  { id: 22, title: 'Koorka Mezhukkuperatti' },
  { id: 23, title: 'Kodappan Thoran' },
  { id: 24, title: 'Mampazha Curry' },
  { id: 25, title: 'Neyyappam' },
  { id: 26, title: 'Pappaya Pulp' },
  { id: 27, title: 'Kumbilappam' },
  { id: 28, title: 'Mango Pulp' },
  { id: 29, title: 'Kappa Puzhuk' },
  { id: 30, title: 'Malabar Porotta' },
  { id: 31, title: 'Laddu Box' },
  { id: 32, title: 'Malabar Porotta' },
  { id: 33, title: 'Parippu Payasam' },
  { id: 34, title: 'Pineapple Pulp' },
  { id: 35, title: 'Plum Cake' },
  { id: 36, title: 'Veg Pulavu' },
  { id: 37, title: 'Papaya Thoran' },
  { id: 38, title: 'Unnakkai' },
  { id: 39, title: 'Steamed Banana' },
  { id: 40, title: 'Vattayappam' },
  { id: 41, title: 'Chikoo Pulp' },
  { id: 42, title: 'Pathiri with Veg Stew' },
  { id: 43, title: 'Rumali Roti' },
  { id: 44, title: 'Pomegranate Pulp' },
  { id: 45, title: 'Vellayappam with Veg Stew' },
  { id: 46, title: 'Sweet Porotta' },
  { id: 47, title: 'Passion Fruit Pulp' },
  { id: 48, title: 'Puttu with Kadala curry' },
  { id: 49, title: 'Veg Biriyani with Pickle' },
  { id: 50, title: 'Palappam with Veg Stew' },
  { id: 51, title: 'Uzhunnu Vada' },
];
...
function renderCards(items) {
  ...
  items.forEach(item => {
      ...
      cardElement.classList.add('col-md-6', 'col-lg-4', 'mb-4', 'mb-md-0');

      // Set the innerHTML of the card
      cardElement.innerHTML = `
          <div class="card p-0 mx-auto" style="width: 20rem;">
              <img class="card-img-top" src="./images/grid-gallery-${item.id}-370x303.jpg" alt="Card image cap">
              <div class="card-body">
...
// Render cards using the items array
renderCards(items);